...
class Shanty_Mongo
{
	...
	public static function init()
	{
		...
		static::addRequirement('Array', new Shanty_Mongo_Validate_Array());
		static::addRequirement('Int', new Shanty_Mongo_Validate_StubTrue());
		static::addRequirement('Float', new Shanty_Mongo_Validate_StubTrue());
		static::addRequirement('Boolean', new Shanty_Mongo_Validate_StubTrue());
	...
	public static $collectionMap = array(
	);
		
	public static function getCollectionRenamed($name) {
		if(isset(self::$collectionMap[$name])) return self::$collectionMap[$name];
		return $name;
	}
}